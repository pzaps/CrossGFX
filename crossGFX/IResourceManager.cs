...
namespace crossGFX
{
    public interface IResourceManager
    {
        ...
        void PrepareResourceDirectory(string resourceDirectory);

        ITexture LoadTextureDirect(string fullFilePath);
        ITexture LoadTexture(string resourceName);
        ITexture LoadTexture(byte[] data);
        IRenderTexture CreateRenderTexture(int width, int height);

        IFont LoadFont(string resourceName);
        IFont LoadFont(byte[] data);
        IFont LoadFontDirect(string fullFilePath);

        IMusic LoadMusic(string resourceName, string songId);
